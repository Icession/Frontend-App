    ...
    <div className="login-container">
      <div className="login-left">
        <div className="left-content">
          ...
          <p>Join thousands of users who trust us for safe and reliable transportation.</p>
        </div>
      </div>
            ...
            <div className="name-row">
              <div className="form-group">
                ...
                <div className="input-wrapper">
                  <select id="gender" name="gender" value={formData.gender}
                    ...
                    style={{ width: "100%", border: "none", background: "transparent", outline: "none", fontSize: "14px", paddingLeft: "8px", color: formData.gender ? "inherit" : "#aaa" }}>
              ...
              <div className="form-group">
                ...
                <div className="input-wrapper">
                  ...
                  <input type="tel" id="contact" name="contact" placeholder="+63 9XX XXX XXXX"
